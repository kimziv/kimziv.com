...
var autoloading, scrollToTop, setTheme, share, startpage, lastId;

startpage = parseInt(window.location.hash.replace("#", "")) || 0;
lastId=-1;
...
autoloading = function(direction, speed) {
  ...
  return $.get("/pick?id=" + startpage+"&last_id="+lastId, function(res) {
    var data;
...
setInterval("autoloading('next')", 1000 * 20);